package cxy.com.loadingview.miclock;
...
public class MiClockView extends View {
    ...
    public MiClockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = ta.getDimension(R.styleable.MiClockView_text_Size, DensityUtils.sp2px(context, 14));
        ta.recycle();

        mHourHandPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mHourHandPaint.setStyle(Paint.Style.FILL);  //设置为实心
        ...
        mScaleLinePaint.setStyle(Paint.Style.STROKE); //设置为空心
